...
proc create_root_design { parentCell } {
  ...
  # Create instance: sim_clk_gen_3, and set properties
  set sim_clk_gen_3 [ create_bd_cell -type ip -vlnv xilinx.com:ip:sim_clk_gen:1.0 sim_clk_gen_3 ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {100000} \
 ] $sim_clk_gen_3
  ...
  set_property -dict [ list \
   CONFIG.CONST_VAL {0x5000000000000} \
   CONFIG.CONST_WIDTH {64} \
 ] $xlconstant_13
  ...
  set_property -dict [ list \
   CONFIG.CONST_VAL {0xfffef3eadc7d28ca} \
   CONFIG.CONST_WIDTH {64} \
 ] $xlconstant_14

  # Create port connections
  connect_bd_net -net sim_clk_gen_0_clk [get_bd_pins sim_clk_gen_0/clk] [get_bd_pins sin_gen_varAmp2_3phi_0/ap_clk]
  connect_bd_net -net sim_clk_gen_1_clk [get_bd_pins sim_clk_gen_1/clk] [get_bd_pins sin_gen_varAmp2_3phi_0/sinc]
  connect_bd_net -net sim_clk_gen_2_clk [get_bd_pins PLL2026_x64_0/ap_clk] [get_bd_pins sim_clk_gen_2/clk]
  connect_bd_net -net sim_clk_gen_3_clk [get_bd_pins PLL2026_x64_0/sinc] [get_bd_pins sim_clk_gen_3/clk]
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_pins sin_gen_varAmp2_3phi_0/ap_start] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlconstant_10_dout [get_bd_pins PLL2026_x64_0/EN5] [get_bd_pins xlconstant_10/dout]
  connect_bd_net -net xlconstant_11_dout [get_bd_pins PLL2026_x64_0/EN4] [get_bd_pins xlconstant_11/dout]
  connect_bd_net -net xlconstant_12_dout [get_bd_pins PLL2026_x64_0/EN3] [get_bd_pins xlconstant_12/dout]
  connect_bd_net -net xlconstant_13_dout [get_bd_pins sin_gen_varAmp2_3phi_0/A_1n] [get_bd_pins xlconstant_13/dout]
  connect_bd_net -net xlconstant_14_dout [get_bd_pins sin_gen_varAmp2_3phi_0/Ang_1n] [get_bd_pins xlconstant_14/dout]
  ...
  connect_bd_net -net xlconstant_3_dout [get_bd_pins PLL2026_x64_0/in_1] [get_bd_pins xlconstant_3/dout]
  connect_bd_net -net xlconstant_4_dout [get_bd_pins PLL2026_x64_0/in_2] [get_bd_pins xlconstant_4/dout]
  connect_bd_net -net xlconstant_5_dout [get_bd_pins PLL2026_x64_0/in_3] [get_bd_pins xlconstant_5/dout]
  connect_bd_net -net xlconstant_6_dout [get_bd_pins PLL2026_x64_0/ap_start] [get_bd_pins xlconstant_6/dout]
  connect_bd_net -net xlconstant_7_dout [get_bd_pins PLL2026_x64_0/EN6] [get_bd_pins xlconstant_7/dout]
  connect_bd_net -net xlconstant_8_dout [get_bd_pins PLL2026_x64_0/EN1] [get_bd_pins xlconstant_8/dout]
  connect_bd_net -net xlconstant_9_dout [get_bd_pins PLL2026_x64_0/EN2] [get_bd_pins xlconstant_9/dout]
