...
entity PLL2026_x64_ATAN_LUT_table_n_V_2_rom is 
    generic(
             DWIDTH     : integer := 49; 
             AWIDTH     : integer := 5; 
             MEM_SIZE    : integer := 31
...
architecture rtl of PLL2026_x64_ATAN_LUT_table_n_V_2_rom is 
...
entity PLL2026_x64_ATAN_LUT_table_n_V_2 is
    generic (
...
architecture arch of PLL2026_x64_ATAN_LUT_table_n_V_2 is
    component PLL2026_x64_ATAN_LUT_table_n_V_2_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    PLL2026_x64_ATAN_LUT_table_n_V_2_rom_U :  component PLL2026_x64_ATAN_LUT_table_n_V_2_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
