...
module design_1
  ...
  design_1_PLL2026_x64_0_0 PLL2026_x64_0
       (.EN1(xlconstant_3_dout),
        .EN2(xlconstant_4_dout),
        .EN3(xlconstant_5_dout),
        .EN4(xlconstant_7_dout),
        .EN5(xlconstant_8_dout),
        .EN6(xlconstant_9_dout),
        .ap_clk(sim_clk_gen_0_clk),
        .ap_rst(1'b0),
        .ap_start(xlconstant_0_dout),
        .in_1(xlconstant_10_dout),
        .in_2(xlconstant_11_dout),
        .in_3(xlconstant_12_dout),
  ...
  design_1_sim_clk_gen_1_1 sim_clk_gen_2
       (.clk(sim_clk_gen_2_clk));
  design_1_sin_gen_varAmp2_3phi_0_0 sin_gen_varAmp2_3phi_0
       (.A_1n({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0}),
  ...
  design_1_xlconstant_9_0 xlconstant_10
       (.dout(xlconstant_10_dout));
  design_1_xlconstant_10_0 xlconstant_11
       (.dout(xlconstant_11_dout));
  design_1_xlconstant_10_1 xlconstant_12
       (.dout(xlconstant_12_dout));
  design_1_xlconstant_2_0 xlconstant_2
       (.dout(xlconstant_2_dout));
  design_1_xlconstant_0_1 xlconstant_3
       (.dout(xlconstant_3_dout));
  design_1_xlconstant_3_0 xlconstant_4
       (.dout(xlconstant_4_dout));
  design_1_xlconstant_3_1 xlconstant_5
       (.dout(xlconstant_5_dout));
  design_1_xlconstant_5_1 xlconstant_7
       (.dout(xlconstant_7_dout));
  design_1_xlconstant_5_2 xlconstant_8
       (.dout(xlconstant_8_dout));
  design_1_xlconstant_8_0 xlconstant_9
