; ModuleID = 'C:/Users/cleit/OneDrive/Documents/GitHub/PLL-2024/AC701/H/sin_gen_varAmp2_3phi_x64/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_sin_gen_varAmp2_3phi_x64_ir(%struct.ap_uint* nocapture readonly %sinc, %struct.ap_uint* nocapture readonly %opt, %struct.ap_fixed* nocapture readonly %f, %struct.ap_fixed* nocapture readonly %A_1p, %struct.ap_fixed* nocapture readonly %Ang_1p, %struct.ap_fixed* nocapture readonly %A_1n, %struct.ap_fixed* nocapture readonly %Ang_1n, %struct.ap_fixed* nocapture readonly %A_5p, %struct.ap_fixed* nocapture readonly %Ang_5p, %struct.ap_fixed* nocapture readonly %A_5n, %struct.ap_fixed* nocapture readonly %Ang_5n, %struct.ap_fixed* nocapture readonly %A_7p, %struct.ap_fixed* nocapture readonly %Ang_7p, %struct.ap_fixed* nocapture readonly %A_7n, %struct.ap_fixed* nocapture readonly %Ang_7n, %struct.ap_fixed* %vout_a, %struct.ap_fixed* %vout_b, %struct.ap_fixed* %vout_c, %struct.ap_fixed* %wtout, %struct.ap_fixed* %dwtout) local_unnamed_addr #0 {
entry:
  ...
  %dwtout_copy5 = alloca %struct.ap_fixed, align 512
  call fastcc void @copy_in(%struct.ap_fixed* %vout_a, %struct.ap_fixed* nonnull align 512 %vout_a_copy1, %struct.ap_fixed* %vout_b, %struct.ap_fixed* nonnull align 512 %vout_b_copy2, %struct.ap_fixed* %vout_c, %struct.ap_fixed* nonnull align 512 %vout_c_copy3, %struct.ap_fixed* %wtout, %struct.ap_fixed* nonnull align 512 %wtout_copy4, %struct.ap_fixed* %dwtout, %struct.ap_fixed* nonnull align 512 %dwtout_copy5)
  call void @apatb_sin_gen_varAmp2_3phi_x64_hw(%struct.ap_uint* %sinc, %struct.ap_uint* %opt, %struct.ap_fixed* %f, %struct.ap_fixed* %A_1p, %struct.ap_fixed* %Ang_1p, %struct.ap_fixed* %A_1n, %struct.ap_fixed* %Ang_1n, %struct.ap_fixed* %A_5p, %struct.ap_fixed* %Ang_5p, %struct.ap_fixed* %A_5n, %struct.ap_fixed* %Ang_5n, %struct.ap_fixed* %A_7p, %struct.ap_fixed* %Ang_7p, %struct.ap_fixed* %A_7n, %struct.ap_fixed* %Ang_7n, %struct.ap_fixed* %vout_a_copy1, %struct.ap_fixed* %vout_b_copy2, %struct.ap_fixed* %vout_c_copy3, %struct.ap_fixed* %wtout_copy4, %struct.ap_fixed* %dwtout_copy5)
  call fastcc void @copy_out(%struct.ap_fixed* %vout_a, %struct.ap_fixed* nonnull align 512 %vout_a_copy1, %struct.ap_fixed* %vout_b, %struct.ap_fixed* nonnull align 512 %vout_b_copy2, %struct.ap_fixed* %vout_c, %struct.ap_fixed* nonnull align 512 %vout_c_copy3, %struct.ap_fixed* %wtout, %struct.ap_fixed* nonnull align 512 %wtout_copy4, %struct.ap_fixed* %dwtout, %struct.ap_fixed* nonnull align 512 %dwtout_copy5)
  ret void
}

; Function Attrs: noinline
define internal fastcc void @copy_in(%struct.ap_fixed*, %struct.ap_fixed* noalias align 512, %struct.ap_fixed*, %struct.ap_fixed* noalias align 512, %struct.ap_fixed*, %struct.ap_fixed* noalias align 512, %struct.ap_fixed*, %struct.ap_fixed* noalias align 512, %struct.ap_fixed*, %struct.ap_fixed* noalias align 512) unnamed_addr #1 {
entry:
...
; Function Attrs: noinline
define internal fastcc void @copy_out(%struct.ap_fixed*, %struct.ap_fixed* noalias align 512, %struct.ap_fixed*, %struct.ap_fixed* noalias align 512, %struct.ap_fixed*, %struct.ap_fixed* noalias align 512, %struct.ap_fixed*, %struct.ap_fixed* noalias align 512, %struct.ap_fixed*, %struct.ap_fixed* noalias align 512) unnamed_addr #5 {
entry:
...
declare void @apatb_sin_gen_varAmp2_3phi_x64_hw(%struct.ap_uint*, %struct.ap_uint*, %struct.ap_fixed*, %struct.ap_fixed*, %struct.ap_fixed*, %struct.ap_fixed*, %struct.ap_fixed*, %struct.ap_fixed*, %struct.ap_fixed*, %struct.ap_fixed*, %struct.ap_fixed*, %struct.ap_fixed*, %struct.ap_fixed*, %struct.ap_fixed*, %struct.ap_fixed*, %struct.ap_fixed*, %struct.ap_fixed*, %struct.ap_fixed*, %struct.ap_fixed*, %struct.ap_fixed*)

define void @sin_gen_varAmp2_3phi_x64_hw_stub_wrapper(%struct.ap_uint*, %struct.ap_uint*, %struct.ap_fixed*, %struct.ap_fixed*, %struct.ap_fixed*, %struct.ap_fixed*, %struct.ap_fixed*, %struct.ap_fixed*, %struct.ap_fixed*, %struct.ap_fixed*, %struct.ap_fixed*, %struct.ap_fixed*, %struct.ap_fixed*, %struct.ap_fixed*, %struct.ap_fixed*, %struct.ap_fixed*, %struct.ap_fixed*, %struct.ap_fixed*, %struct.ap_fixed*, %struct.ap_fixed*) #6 {
entry:
  call void @copy_out(%struct.ap_fixed* null, %struct.ap_fixed* %15, %struct.ap_fixed* null, %struct.ap_fixed* %16, %struct.ap_fixed* null, %struct.ap_fixed* %17, %struct.ap_fixed* null, %struct.ap_fixed* %18, %struct.ap_fixed* null, %struct.ap_fixed* %19)
  call void @sin_gen_varAmp2_3phi_x64_hw_stub(%struct.ap_uint* %0, %struct.ap_uint* %1, %struct.ap_fixed* %2, %struct.ap_fixed* %3, %struct.ap_fixed* %4, %struct.ap_fixed* %5, %struct.ap_fixed* %6, %struct.ap_fixed* %7, %struct.ap_fixed* %8, %struct.ap_fixed* %9, %struct.ap_fixed* %10, %struct.ap_fixed* %11, %struct.ap_fixed* %12, %struct.ap_fixed* %13, %struct.ap_fixed* %14, %struct.ap_fixed* %15, %struct.ap_fixed* %16, %struct.ap_fixed* %17, %struct.ap_fixed* %18, %struct.ap_fixed* %19)
  call void @copy_in(%struct.ap_fixed* null, %struct.ap_fixed* %15, %struct.ap_fixed* null, %struct.ap_fixed* %16, %struct.ap_fixed* null, %struct.ap_fixed* %17, %struct.ap_fixed* null, %struct.ap_fixed* %18, %struct.ap_fixed* null, %struct.ap_fixed* %19)
  ret void
}

declare void @sin_gen_varAmp2_3phi_x64_hw_stub(%struct.ap_uint*, %struct.ap_uint*, %struct.ap_fixed*, %struct.ap_fixed*, %struct.ap_fixed*, %struct.ap_fixed*, %struct.ap_fixed*, %struct.ap_fixed*, %struct.ap_fixed*, %struct.ap_fixed*, %struct.ap_fixed*, %struct.ap_fixed*, %struct.ap_fixed*, %struct.ap_fixed*, %struct.ap_fixed*, %struct.ap_fixed*, %struct.ap_fixed*, %struct.ap_fixed*, %struct.ap_fixed*, %struct.ap_fixed*)
