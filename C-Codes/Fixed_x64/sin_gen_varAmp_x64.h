#ifndef SIN_GEN_VARAMP_X64_
#define SIN_GEN_VARAMP_X64_
...
// Cabeçalho
void sin_gen__varAmp_x64(uint1_t sinc, uint1_t opt, data_t A, data_t f, data_t Ang, data_t *vout, data_t *vqout, data_t *wtout);
