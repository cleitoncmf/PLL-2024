...
void sin_gen_harm_x64(uint1_t sinc, data_t f,
    ...
    if(aux_sinc == sinc){
        ...
        v = A1*sin_2000(wt+Ang1) + A3*sin_2000(wt*3+Ang3) + A5*sin_2000(wt*5+Ang5) + A7*sin_2000(wt*7+Ang7);
...
data_t sin_2000(data_t theta){
    ...
    over2pi = data_t(0.15915494309)*theta_abs_0;

    if(theta_abs_0>pi2){
    	theta_abs = theta_abs_0 -hls::trunc(over2pi)*pi2;
    }
    else{
    	theta_abs = theta_abs_0;
    }

    /*while(theta_abs>pi2){
    	theta_abs = theta_abs - pi2;
    }*/
